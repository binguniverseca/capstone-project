        ...
        switch (view.getId()) {
            case R.id.btn_register:
                ...
                if (TextUtils.isEmpty(account) || TextUtils.isEmpty(password) || TextUtils.isEmpty(confirm)) {
                    Toast.makeText(RegisterActivity.this, "Account ID and password cannot be empty", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(RegisterActivity.this, "Account ID and password should be longer than 6", Toast.LENGTH_SHORT).show();
                } else {
            ...
            case R.id.tv_return:
                ...
                break;
            case R.id.tv_member:
                Toast.makeText(this, "You are the member", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
