...
public class SportActivity extends AppCompatActivity {
    ...
    private Sport[] sports = {new Sport("Ballet training", R.drawable.p1),
            new Sport("Dance training", R.drawable.p2),
            new Sport("HIIT basics", R.drawable.p3),
            new Sport("KeepKit.15 minutes running", R.drawable.p4),
            new Sport("Arms strength training", R.drawable.p5),
            new Sport("HIIT medium, R.drawable.p6),
            new Sport("HIIT advanced, R.drawable.p7)
    };
