        ...
        switch (view.getId()) {
            case R.id.btn_login:
                ...
                if (TextUtils.isEmpty(acc) || TextUtils.isEmpty(pass)) {
                    Toast.makeText(LoginActivity.this, "Account or username cannot be empty", Toast.LENGTH_SHORT).show();
                    ...
                    editor.apply();
                    Toast.makeText(LoginActivity.this, "Welcome login", Toast.LENGTH_SHORT).show();
